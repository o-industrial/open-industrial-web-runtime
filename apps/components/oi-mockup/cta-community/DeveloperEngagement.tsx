    ...
    <section class='py-16 px-6 bg-[#0A1F44] text-white'>
      <div class='max-w-4xl mx-auto text-center'>
        <h2 class='text-3xl font-bold text-neon-blue mb-4'>
          Integrate, Customize & Extend Open Industrial’s AI Execution Framework
        </h2>
        <p class='text-lg text-neutral-300'>
          Access Open Industrial’s API, SDKs, and integration tools to build and extend AI-powered
          execution workflows.
        </p>
      </div>
      <div class='mt-10 grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto'>
        ...
        <div class='p-6 bg-[#112E60] rounded-lg shadow-md text-center'>
          ...
          <p class='mt-2 text-neutral-300'>
            Collaborate with Open Industrial’s partner network to deploy AI execution solutions
            seamlessly.
          </p>
        </div>
      </div>
