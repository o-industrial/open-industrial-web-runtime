...
export function Logo(_props: LogoProps): JSX.Element {
  return (
	...
	.st0{fill:#6666FF;}
      ...
      <path d='M70.9,29.3c1.6,2.4,2.4,5.6,2.4,9.9c0,2.6-0.4,4.9-1.2,7c-0.8,2.1-2,3.7-3.5,4.8c-1.5,1.2-3.3,1.8-5.2,1.8
	...
	c0.4,0.3,0.9,0.4,1.5,0.4C62.5,46.2,63.7,43.9,63.7,39.4z' />
      <path d='M99.7,41.9H84.5c0.2,1.7,0.8,2.8,1.6,3.4s2,0.9,3.5,0.9c0.9,0,1.8-0.2,2.7-0.5c0.9-0.4,1.9-0.9,3-1.7l3.8,5.1
	...
	c1.9-1.2,4.2-1.8,6.8-1.8c2.5,0,4.6,0.5,6.5,1.6c1.8,1,3.3,2.5,4.3,4.5c1,2,1.5,4.3,1.5,7.1C99.9,39.8,99.8,40.8,99.7,41.9z
	 M90.7,36.4c0-1.5-0.3-2.6-0.7-3.4c-0.4-0.8-1.2-1.2-2.3-1.2c-1,0-1.8,0.4-2.3,1.1c-0.5,0.7-0.9,2-1,3.9h6.3V36.4z' />
      <path d='M123.8,27.8c1.2,1.3,1.8,3.2,1.8,5.5v18.5h-9.3V35c0-0.9-0.1-1.6-0.4-1.9c-0.2-0.3-0.6-0.5-1.1-0.5c-1,0-2.1,0.8-3.1,2.5
	...
	c-1.5,0.6-3.2,0.8-5.2,0.8C345.2,52.8,343.2,52.1,341.9,50.7z'
      />
      <path d='M25.5,13L25.5,13C14.2,13,5,22.1,5,33.4c0,8.2,4.9,15.6,12.4,18.8l4.6-12.1c-2.4-1.2-4.1-3.8-4.1-6.7c0-4.1,3.4-7.5,7.5-7.5
