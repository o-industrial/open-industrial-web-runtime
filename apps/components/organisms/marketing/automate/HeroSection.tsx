  ...
  return (
    ...
    >
      ...
      <div class='mx-auto max-w-7xl px-6 lg:px-8 text-center space-y-10'>
        ...
        <p class='mt-6 text-lg leading-8 text-neutral-300 max-w-2xl mx-auto'>
          OpenIndustrial is a cloud-native industrial integration hub and AI-native execution engine
          that helps teams connect legacy systems, shape automation logic, and run reflexive,
