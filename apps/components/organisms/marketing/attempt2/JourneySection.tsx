...
const JourneySection: FunctionalComponent = () => {
  ...
  return (
    <section class="bg-gradient-to-b from-neutral-100 dark:from-neutral-950 via-neon-violet-500/20 dark:via-neon-violet-500/20 to-neutral-100 dark:to-neutral-950 py-32 px-6 lg:px-8">
