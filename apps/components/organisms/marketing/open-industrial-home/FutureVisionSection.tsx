...
export default function FutureVisionSection(): JSX.Element {
  return (
    ...
    >
      ...
      >
        <div class='absolute inset-0 bg-[radial-gradient(circle,_rgba(129,140,248,0.12),_rgba(7,9,20,0)_70%)] dark:bg-[radial-gradient(circle,_rgba(129,140,248,0.2),_rgba(8,13,35,0)_74%)]' />
