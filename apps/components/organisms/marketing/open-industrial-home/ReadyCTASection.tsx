...
export default function ReadyCTASection(): JSX.Element {
  ...
  return (
    <SectionSurface
      ...
      class='relative overflow-hidden rounded-t-[48px] border border-neutral-200/60 bg-gradient-to-b from-white via-neutral-100 to-neutral-200 shadow-[0_60px_160px_-90px_rgba(15,23,42,0.2)] backdrop-blur-xl dark:border-white/10 dark:bg-neutral-950 dark:shadow-[0_60px_160px_-90px_rgba(15,23,42,0.65)]'
    >
      <div class='pointer-events-none absolute inset-0 opacity-60'>
        <div class='absolute left-1/2 top-[-10%] h-72 w-72 -translate-x-1/2 rounded-full bg-[radial-gradient(circle,_rgba(129,140,248,0.28),_rgba(255,255,255,0)_72%)] blur-[140px]' />
        <div class='absolute inset-x-20 bottom-[-45%] h-[18rem] rounded-full bg-[conic-gradient(from_150deg,_rgba(34,211,238,0.18),_rgba(99,102,241,0.16),_rgba(255,255,255,0))] blur-[160px]' />
      </div>
