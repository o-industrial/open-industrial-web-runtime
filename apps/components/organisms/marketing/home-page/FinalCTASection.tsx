...
import { AziInnerVoice } from '@o-industrial/atomic/molecules';
  ...
  return (
    <section class='flex flex-col items-center text-center px-6 py-24 space-y-6'>
      ...
      <p class='text-lg text-neutral-300 max-w-2xl'>
        Everything you’ve seen can run in CLI, GitOps, or edge. Your runtime is yours — and it
        doesn’t wait for a login.
      </p>
      ...
      <AziInnerVoice intentType={IntentTypes.Tertiary}>
        This isn’t a product tour. It’s your system — waiting to be remembered.
      </AziInnerVoice>
    </section>
  );
}
