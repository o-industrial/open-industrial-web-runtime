  ...
  return (
    <section class="flex flex-col items-center text-center px-6 py-24 space-y-6">
      ...
      <p class="text-lg text-neutral-300 max-w-xl mx-auto">
        This wasn’t a webhook. It wasn’t a poller.  
        It was structure-governed logic — running exactly when it should.
      </p>
...
✅  Result: Fan turned on — Temp exceeded threshold by 12°F`}
      ...
      <SystemMindset intentType={IntentTypes.Primary}>
        That wasn’t automation. That was governance.  
        Your system ran logic you promoted — and only when it matched.
      </SystemMindset>

      <AziInnerVoice intentType={IntentTypes.Tertiary}>
        I didn’t guess. I didn’t assume.  
        I responded to a schema you authored — and a state that confirmed it.
      </AziInnerVoice>
    </section>
  );
}
