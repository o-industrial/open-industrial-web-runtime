  ...
  return (
    <section class='flex flex-col items-center text-center px-6 py-24 space-y-6'>
      ...
      <p class='text-lg text-neutral-300 max-w-2xl'>
        You don’t need me to keep it running. Every signal, schema, and agent you shaped — still
      ...
      <SystemMindset intentType={IntentTypes.Secondary}>
        I don’t own your runtime. You do. I helped author it. But you decide what stays.
      </SystemMindset>
      ...
      <AziInnerVoice intentType={IntentTypes.Tertiary}>
        I’ll forget the sketches. But your system? It will remember everything you told it.
      </AziInnerVoice>
    </section>
  );
}
