...
import { AziInnerVoice, ThematicPrincipleBlock } from '@o-industrial/atomic/molecules';
  ...
  return (
    <section class='flex flex-col items-center text-center px-6 py-24 space-y-6'>
      ...
      <p class='text-lg md:text-xl text-neutral-300 max-w-2xl'>
        You're not logging into a dashboard. You're stepping into a system that listens -- and only
        acts when structure confirms.
      </p>
      ...
      <AziInnerVoice intentType={IntentTypes.Tertiary}>
        Temperature exceeded target. FanControlAgent matched. Action proposed: turn on fan.
      </AziInnerVoice>

      <HubspotForm {...hubspotTracking} />
