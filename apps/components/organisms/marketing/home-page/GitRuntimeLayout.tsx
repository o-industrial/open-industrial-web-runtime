  ...
  return (
    <section class="flex flex-col items-center text-center px-6 py-24 space-y-6">
      ...
      <p class="text-lg text-neutral-300 max-w-2xl">
        Every schema, agent, and surface you create lives in a Git-native
        structure. Version it. Diff it. Deploy it anywhere.
      </p>
      ...
      <SystemMindset intentType={IntentTypes.Tertiary}>
        Your system isn’t a dashboard. It’s a contract — and it lives in code
        you control.
      </SystemMindset>
    </section>
  );
