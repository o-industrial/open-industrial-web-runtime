  ...
  return (
    <section class="flex flex-col items-center text-center px-6 py-24 space-y-6">
      ...
      <p class="text-lg text-neutral-300 max-w-2xl">
        You can fork a complete system — structure, schemas, signals, and logic — in seconds.
        No boilerplate. No guesswork. No empty dashboards.
      </p>
      ...
      <SystemMindset intentType={IntentTypes.Tertiary}>
        ...
        It’s a live system you can promote, diff, and deploy.
      </SystemMindset>

      <AziInnerVoice intentType={IntentTypes.Tertiary}>
        RoomState. FanControl. Config. Schema lineage.  
        Everything I knew — ready to evolve with you.
      </AziInnerVoice>
    </section>
  );
}
