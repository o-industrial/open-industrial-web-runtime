    ...
    >
      ...
      <div class='mx-auto max-w-7xl px-6 lg:px-8 text-center space-y-10'>
        ...
        <p class='mt-6 text-lg leading-8 text-neutral-300 max-w-2xl mx-auto'>
          Just like PDM versioned the design layer — Open Industrial governs the runtime. Reflex
          logic. Forkable agents. Structured memory. All inside your own system.
        </p>

        <p class='text-sm leading-6 text-neutral-400 max-w-md mx-auto italic'>
          <strong class='text-white'>Azi</strong>{' '}
          helps you scaffold logic, propose schema changes, and evolve your runtime — but when she
          steps away, your system keeps running. That’s sovereignty.
        </p>
