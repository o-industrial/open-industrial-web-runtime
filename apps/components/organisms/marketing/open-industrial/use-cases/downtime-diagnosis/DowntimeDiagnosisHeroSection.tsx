...
export default function DowntimeDiagnosisHeroSection(): JSX.Element {
  const primaryAction = downtimeDiagnosisHero.primaryAction;
  const secondaryAction = downtimeDiagnosisHero.secondaryAction;
  ...
  return (
    <section class='relative overflow-hidden bg-gradient-to-br from-[#070a1e] via-[#111536] to-[#050716] py-24 text-white shadow-[0_70px_200px_-90px_rgba(10,16,42,0.85)]'>
      <div class='pointer-events-none absolute inset-0'>
        ...
        <div class='absolute -left-32 bottom-[-18%] h-[420px] w-[420px] rounded-full bg-[radial-gradient(circle,_rgba(56,189,248,0.24),_rgba(7,10,22,0)_72%)] blur-[170px]' />
