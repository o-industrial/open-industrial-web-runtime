...
import { crossLinePerformanceIntegrationSteps } from '../../../../../../../src/marketing/use-case/cross-line-performance.ts';
...
export default function CrossLinePerformanceIntegrationOverviewSection(): JSX.Element {
  return (
      ...
      <div class='space-y-12 text-neutral-700 dark:text-neutral-200'>
        <div class='mx-auto max-w-3xl space-y-4 text-center'>
          ...
          <h2 class='text-balance text-3xl font-semibold tracking-tight text-neutral-900 sm:text-4xl dark:text-white'>
            Unite Every Line Performance Signal in One Hub
          </h2>
          <p class='text-base leading-relaxed text-neutral-700 sm:text-lg dark:text-neutral-300'>
            Open Industrial connects production, control, quality, and historian feeds so teams can
            compare lines without manual data prep.
          </p>
        </div>

        <ol class='mx-auto grid w-full max-w-4xl gap-4 text-left sm:grid-cols-2'>
          {crossLinePerformanceIntegrationSteps.map((step, index) => (
            <li
              key={step}
