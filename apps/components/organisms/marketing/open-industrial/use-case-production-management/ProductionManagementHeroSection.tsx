...
} from '../../../../../../src/marketing/use-case-production-management.ts';
...
export default function ProductionManagementHeroSection(): JSX.Element {
  const primaryAction = productionManagementHero.primaryAction;
  const secondaryAction = productionManagementHero.secondaryAction;

  return (
    <section class='relative overflow-hidden bg-gradient-to-br from-[#120815] via-[#1f1030] to-[#090514] py-24 text-white shadow-[0_70px_200px_-90px_rgba(12,5,18,0.9)]'>
      <div class='pointer-events-none absolute inset-0'>
        <div class='absolute left-1/2 top-[-28%] h-[560px] w-[560px] -translate-x-1/2 rounded-full bg-[radial-gradient(circle,_rgba(168,85,247,0.28),_rgba(12,8,20,0)_78%)] blur-[200px]' />
