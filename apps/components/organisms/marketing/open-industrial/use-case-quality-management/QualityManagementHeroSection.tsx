...
} from '../../../../../../src/marketing/use-case-quality-management.ts';
...
export default function QualityManagementHeroSection(): JSX.Element {
  const primaryAction = qualityManagementHero.primaryAction;
  const secondaryAction = qualityManagementHero.secondaryAction;

  return (
    <section class='relative overflow-hidden bg-gradient-to-br from-[#081124] via-[#101c3b] to-[#050a1a] py-24 text-white shadow-[0_70px_200px_-90px_rgba(8,12,28,0.85)]'>
      <div class='pointer-events-none absolute inset-0'>
        <div class='absolute left-1/2 top-[-28%] h-[560px] w-[560px] -translate-x-1/2 rounded-full bg-[radial-gradient(circle,_rgba(59,130,246,0.22),_rgba(9,12,26,0)_78%)] blur-[200px]' />
