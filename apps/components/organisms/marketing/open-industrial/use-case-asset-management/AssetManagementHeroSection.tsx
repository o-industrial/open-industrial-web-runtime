...
} from '../../../../../../src/marketing/use-case-asset-management.ts';
...
export default function AssetManagementHeroSection(): JSX.Element {
  const primaryAction = assetManagementHero.primaryAction;
  const secondaryAction = assetManagementHero.secondaryAction;

  return (
    <section class='relative overflow-hidden bg-gradient-to-br from-[#051b12] via-[#0b3321] to-[#041015] py-24 text-white shadow-[0_70px_200px_-90px_rgba(4,16,15,0.9)]'>
      <div class='pointer-events-none absolute inset-0'>
        <div class='absolute left-1/2 top-[-28%] h-[560px] w-[560px] -translate-x-1/2 rounded-full bg-[radial-gradient(circle,_rgba(16,185,129,0.25),_rgba(6,18,14,0)_78%)] blur-[200px]' />
        <div class='absolute -left-32 bottom-[-18%] h-[420px] w-[420px] rounded-full bg-[radial-gradient(circle,_rgba(59,130,246,0.24),_rgba(7,18,18,0)_72%)] blur-[170px]' />
        <div class='absolute -right-24 top-16 h-[420px] w-[420px] rounded-full bg-[radial-gradient(circle,_rgba(20,184,166,0.24),_rgba(8,16,22,0)_72%)] blur-[180px]' />
      </div>
