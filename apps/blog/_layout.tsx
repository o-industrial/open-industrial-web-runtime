...
export default function DocsLayout({ Data, Component, Revision }: PageProps) {
  return (
    <html class='dark'>
      <head>
        <meta charSet='utf-8' />
      ...
      <body class='bg-neutral-50 dark:bg-neutral-900 text-neutral-900 dark:text-neutral-50'>
        <div class='h-screen flex flex-col'>
          <Header config={Data.$DocsConfig} activePath={Data.CurrentPath} />

          {/* Main Layout */}
          <div class='flex flex-1 overflow-hidden'>
            <SidebarNav
              class='hidden sm:block'
              config={Data.$DocsConfig}
              activePath={Data.CurrentPath}
            />

            {/* Main Content Area */}
            <main class='flex-1 flex flex-col overflow-y-auto'>
              <div class='flex-1 grid grid-cols-1 lg:grid-cols-[minmax(0,1fr)_300px] gap-8 px-4 md:px-8 py-10 max-w-none prose dark:prose-invert'>
                {/* MDX Content */}
                <div class=''>
                  <Component />
                </div>
