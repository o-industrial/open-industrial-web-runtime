  ...
  return (
    <div class='-:-:p-6 -:-:space-y-6'>
      <div class='-:-:flex -:-:items-center -:-:justify-between'>
        <h1 class='-:-:text-2xl -:-:font-semibold -:-:text-neutral-100'>License: {LicLookup}</h1>
      ...
      <section class='-:-:space-y-3'>
        <div class='-:-:rounded-xl -:-:border -:-:border-neutral-700 -:-:bg-neutral-900/60 -:-:p-4 -:-:space-y-4'>
          <div>
            ...
            <p class='-:-:text-xs -:-:text-neutral-400'>Configure the Stripe license settings.</p>
          </div>
          <form
            method='POST'
      ...
      <section class='-:-:space-y-3'>
        <div class='-:-:rounded-xl -:-:border -:-:border-neutral-700 -:-:bg-neutral-900/60 -:-:p-4 -:-:space-y-4'>
          <div class='-:-:flex -:-:items-center -:-:justify-between'>
            <div>
              <h2 class='-:-:text-lg -:-:font-semibold -:-:text-neutral-100'>Plans</h2>
              <p class='-:-:text-xs -:-:text-neutral-400'>Each plan can have multiple prices.</p>
            </div>
          </div>
          <ul class='-:-:space-y-2'>
            ...
            {Object.entries(license.Plans || {}).map(([planLookup, plan]) => (
              <li key={planLookup} class='-:-:flex -:-:items-center -:-:justify-between -:-:gap-2'>
                <div class='-:-:text-neutral-200'>{plan.Details?.Name || planLookup}</div>
                <Action
          ...
          >
            <Input label='New plan lookup' name='PlanLookup' placeholder='e.g., basic' />
            <Action type='submit' intentType={3}>Create Plan</Action>
          </form>
        </div>
      </section>
      ...
      <section class='-:-:space-y-3'>
        <div class='-:-:rounded-xl -:-:border -:-:border-neutral-700 -:-:bg-neutral-900/60 -:-:p-4 -:-:space-y-4'>
          <h2 class='-:-:text-lg -:-:font-semibold -:-:text-neutral-100'>Coupons</h2>
          <ul class='-:-:space-y-2'>
            ...
            {Object.entries(Existing?.Coupons || {}).map(([cLookup, c]) => (
              <li key={cLookup}>
                <span class='-:-:text-neutral-200'>{c.Details?.Name || cLookup}</span>
              </li>
            ))}
          </ul>
        </div>
