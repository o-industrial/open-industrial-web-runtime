...
export default function AdminWorkspaceManagePage(
  { Data: { Workspace } }: PageProps<WorkspaceManageData>,
) {
  const eac = Workspace || {};
    ...
    <div class='-:-:p-6 -:-:space-y-6 -:-:pb-28'>
        ...
        <div class='-:-:flex -:-:items-center -:-:gap-2'>
          {owner && (
            <Action
              ...
              styleType={ActionStyleTypes.Outline | ActionStyleTypes.Rounded | ActionStyleTypes.UltraThin}
            >
              Owner: {owner}
            </Action>
          )}
          {lookup && (
            <span class='-:-:text-xs -:-:text-neutral-500'>Lookup: {lookup}</span>
          )}
        </div>
      </div>
      ...
      <div class='-:-:grid -:-:grid-cols-1 md:-:-:grid-cols-2 -:-:gap-4'>
        <PanelShell class='-:-:rounded-xl -:-:border -:-:border-neutral-800 -:-:bg-neutral-900/50 -:-:p-4'>
          <h2 class='-:-:text-lg -:-:font-semibold -:-:text-neutral-100'>Overview</h2>
        ...
        <PanelShell class='-:-:rounded-xl -:-:border -:-:border-neutral-800 -:-:bg-neutral-900/50 -:-:p-4'>
          <h2 class='-:-:text-lg -:-:font-semibold -:-:text-neutral-100'>Azure Clouds</h2>
          {azureClouds.length === 0 && (
            <div class='-:-:mt-3 -:-:text-neutral-400'>No Azure clouds configured.</div>
          )}
          <div class='-:-:mt-3 -:-:space-y-3'>
            {azureClouds.map(([cloudLookup, cloud]) => {
              const tenantId = cloud?.Details?.TenantID || '';
              const subId = cloud?.Details?.SubscriptionID || '';
              const appId = cloud?.Details?.ApplicationID || '';
              ...
              return (
                <div class='-:-:rounded-md -:-:border -:-:border-neutral-800 -:-:bg-neutral-900/50 -:-:p-3 -:-:space-y-2' key={cloudLookup}>
                  ...
                  <div class='-:-:grid -:-:grid-cols-1 md:-:-:grid-cols-2 -:-:gap-2'>
                    ...
                    <SummaryRowWithAction
                      ...
                      actionLabel='Open'
                      onActionClick={() => subUrl ? window.open(subUrl, '_blank') : null}
                    />
                  </div>
                    ...
                    <div class='-:-:pt-2 -:-:space-y-1'>
                      {rgEntries.map(([rgName, rg]) => {
                        ...
                        return (
                          <SummaryRowWithAction
                            key={rgName}
                            label={`${rg?.Details?.Name || rgName} ${rg?.Details?.Location ? `(${rg.Details.Location})` : ''}`}
                            actionLabel='Open'
                            onActionClick={() => rgUrl ? window.open(rgUrl, '_blank') : null}
                            class='-:-:text-xs'
                          />
                        );
                      })}
      ...
      {showSurfaces && (
        <PanelShell class='-:-:rounded-xl -:-:border -:-:border-neutral-800 -:-:bg-neutral-900/50 -:-:p-4'>
          <h2 class='-:-:text-lg -:-:font-semibold -:-:text-neutral-100'>Surfaces</h2>
          {surfaces.length === 0 && (
            <div class='-:-:mt-2 -:-:text-neutral-400'>No surfaces defined.</div>
          )}
          <div class='-:-:mt-3 -:-:space-y-2'>
            {surfaces.map(([lookup, s]: [string, any]) => {
              ...
              return (
                <div key={lookup} class='-:-:rounded -:-:border -:-:border-neutral-800 -:-:p-3'>
                  <div class='-:-:flex -:-:items-start -:-:justify-between -:-:gap-3'>
                    <div class='-:-:text-sm -:-:text-neutral-200 -:-:min-w-0'>
                      ...
                      <div class='-:-:mt-1 -:-:flex -:-:flex-wrap -:-:gap-1'>
                        {parent && (
                          <Action
                            styleType={ActionStyleTypes.Outline | ActionStyleTypes.UltraThin | ActionStyleTypes.Rounded}
                            title='Parent Surface'
                          >
                            Parent: {parent}
                          </Action>
                        )}
                        <Action styleType={ActionStyleTypes.Outline | ActionStyleTypes.UltraThin | ActionStyleTypes.Rounded}>DCs: {dcCount}</Action>
                        <Action styleType={ActionStyleTypes.Outline | ActionStyleTypes.UltraThin | ActionStyleTypes.Rounded}>Agents: {agCount}</Action>
                        <Action styleType={ActionStyleTypes.Outline | ActionStyleTypes.UltraThin | ActionStyleTypes.Rounded}>Schemas: {scCount}</Action>
                        <Action styleType={ActionStyleTypes.Outline | ActionStyleTypes.UltraThin | ActionStyleTypes.Rounded}>WQs: {wqCount}</Action>
                      </div>
                    </div>
      ...
      {showSchemas && (
        <PanelShell class='-:-:rounded-xl -:-:border -:-:border-neutral-800 -:-:bg-neutral-900/50 -:-:p-4'>
          <h2 class='-:-:text-lg -:-:font-semibold -:-:text-neutral-100'>Schemas</h2>
          {schemas.length === 0 && (
                ...
                <div key={lookup} class='-:-:rounded -:-:border -:-:border-neutral-800 -:-:p-3'>
                  <div class='-:-:flex -:-:items-start -:-:justify-between -:-:gap-3'>
                    <div class='-:-:text-sm -:-:text-neutral-200 -:-:min-w-0'>
                      ...
                      <div class='-:-:mt-1 -:-:flex -:-:flex-wrap -:-:gap-1'>
                        <Action styleType={ActionStyleTypes.Outline | ActionStyleTypes.UltraThin | ActionStyleTypes.Rounded}>Type: {type}</Action>
                        {version && (
                          <Action styleType={ActionStyleTypes.Outline | ActionStyleTypes.UltraThin | ActionStyleTypes.Rounded}>v{version}</Action>
                        )}
                        {dc && (
                          <Action
                            styleType={ActionStyleTypes.Outline | ActionStyleTypes.UltraThin | ActionStyleTypes.Rounded}
                        ...
                        <Action styleType={ActionStyleTypes.Outline | ActionStyleTypes.UltraThin | ActionStyleTypes.Rounded}>Refs: {refs}</Action>
                      </div>
                    </div>
                    <div class='-:-:shrink-0 -:-:flex -:-:gap-2'>
                      <Action
      ...
      {showDataConns && (
        <PanelShell class='-:-:rounded-xl -:-:border -:-:border-neutral-800 -:-:bg-neutral-900/50 -:-:p-4'>
          <h2 class='-:-:text-lg -:-:font-semibold -:-:text-neutral-100'>Data Connections</h2>
          {dataConns.length === 0 && (
            <div class='-:-:mt-2 -:-:text-neutral-400'>No data connections defined.</div>
          )}
          <div class='-:-:mt-3 -:-:space-y-2'>
                  ...
                  <div class='-:-:flex -:-:items-start -:-:justify-between -:-:gap-3'>
                    <div class='-:-:text-sm -:-:text-neutral-200 -:-:min-w-0'>
                      ...
                      <div class='-:-:mt-1 -:-:flex -:-:flex-wrap -:-:gap-1'>
                        <Action styleType={ActionStyleTypes.Outline | ActionStyleTypes.UltraThin | ActionStyleTypes.Rounded}>Type: {type}</Action>
                        {sim && (
                          <Action styleType={ActionStyleTypes.Outline | ActionStyleTypes.UltraThin | ActionStyleTypes.Rounded}>Sim: {sim}</Action>
                        )}
                        {mp.length > 0 && (
                          <Action styleType={ActionStyleTypes.Outline | ActionStyleTypes.UltraThin | ActionStyleTypes.Rounded} title='Multi-protocol ingest modes'>
                            Modes: {mp.join(', ')}
                          </Action>
                        )}
                      </div>
      ...
      {showWarmQueries && (
        <PanelShell class='-:-:rounded-xl -:-:border -:-:border-neutral-800 -:-:bg-neutral-900/50 -:-:p-4'>
          <h2 class='-:-:text-lg -:-:font-semibold -:-:text-neutral-100'>Warm Queries</h2>
          {warmQueries.length === 0 && (
            <div class='-:-:mt-2 -:-:text-neutral-400'>No warm queries defined.</div>
          )}
          <div class='-:-:mt-3 -:-:space-y-2'>
            {warmQueries.map(([lookup, wq]: [string, any]) => {
              ...
              const qPreview = (query || '').slice(0, 80) + (query && query.length > 80 ? '…' : '');
              return (
                <div key={lookup} class='-:-:rounded -:-:border -:-:border-neutral-800 -:-:p-3'>
                  <div class='-:-:flex -:-:items-start -:-:justify-between -:-:gap-3'>
                    <div class='-:-:text-sm -:-:text-neutral-200 -:-:min-w-0'>
                      ...
                      <div class='-:-:mt-1 -:-:flex -:-:flex-wrap -:-:gap-1'>
                        ...
                        {apiPath && (
                          <Action styleType={ActionStyleTypes.Outline | ActionStyleTypes.UltraThin | ActionStyleTypes.Rounded}>ApiPath: {apiPath}</Action>
                        )}
                      </div>
                      {qPreview && (
                        <div class='-:-:mt-1 -:-:text-xs -:-:text-neutral-400 -:-:truncate' title={query}>
                          {qPreview}
                        </div>
                      )}
                    </div>
