...
<figure class="my-10 flex flex-col items-center text-center max-w-4xl mx-auto">
  <img 
    src="/assets/Azi-Language-Map.png" 
    data-eac-bypass-base
    alt="Azi’s Shared Language Map"
  ...
  <figcaption class="mt-4 text-sm text-fuchsia-300 tracking-wide uppercase">
    These are the terms you and Azi use to co-create meaning and execution
  </figcaption>
</figure>

In Open Industrial, terms aren’t just definitions. They’re behaviors. Structures. Promises. You and Azi use these words to align on meaning, trigger logic, evolve schema, and shape systems together. This isn’t a reference—it’s a relationship. A collaborative map of how execution works.

Let’s walk through the language of Open Industrial, grouped by how your system thinks, adapts, and collaborates.
