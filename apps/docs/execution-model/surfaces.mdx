...
<figure class="my-10 flex flex-col items-center text-center max-w-4xl mx-auto">
  <img 
    src="/assets/Execution-Surface-Diagram.png" 
    data-eac-bypass-base
    alt="What lives on an Execution Surface"
  ...
  <figcaption class="mt-4 text-sm text-cyan-300 tracking-wide uppercase">
    Schema. Agents. Impulses. Signals. This is where logic lives—and evolves.
  </figcaption>
</figure>
...
All execution in Open Industrial is scoped to a Surface:
...
> _“When you leave Open Industrial, your Surfaces come with you.”_
