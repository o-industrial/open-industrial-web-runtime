# Workspace: Schema-Driven Execution & Team Collaboration

> *A Workspace is where you and Azi build together. It’s where context lives.*

A Workspace in Open Industrial isn’t just a folder on disk—it’s a shared memory for your system. It captures every evolving piece of structure, logic, and execution state in one composable container. It’s where you teach Azi what matters, observe system behavior in real-time, and promote structure your team can rely on.

<figure class="my-10 flex flex-col items-center text-center max-w-4xl mx-auto">
  <img 
    src="/assets/OpenIndustrial-Workspace-Overview.png" 
    data-eac-bypass-base
    alt="Open Industrial Workspace Overview"
  ...
  <figcaption class="mt-4 text-sm text-indigo-300 tracking-wide uppercase">
    Schema. Agents. Surfaces. Memory. Collaboration. This is where it all lives.
  </figcaption>
</figure>

> *"This agent is drifting from its last known pattern. Want me to raise a Signal?"* — Azi
...
This is the core dev loop in Open Industrial—observable, adaptive, and grounded in real context.
...
> *"You onboard teammates into a Workspace, not a wiki."*
...
> *"It’s not just a folder. It’s the shape of your evolving system."*
