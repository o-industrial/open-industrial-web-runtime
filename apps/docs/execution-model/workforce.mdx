...
<figure class="my-10 flex flex-col items-center text-center max-w-4xl mx-auto">
  <img 
    src="/assets/Virtual-Workforce-Diagram.png" 
    data-eac-bypass-base
    alt="Virtual Workforce: Schema-bound agents coordinated by Azi"
  ...
  <figcaption class="mt-4 text-sm text-teal-300 tracking-wide uppercase">
    Your agents respond to schema. Azi observes. You decide what evolves.
  </figcaption>
</figure>
